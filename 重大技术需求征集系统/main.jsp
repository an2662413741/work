                        ...
                        <div id="bs_bannerright">
                            ...
                            <div class="bs_nav">
                                <div class="bs_navleft">
                                    ...
                                    <li>
                                        <span id="username">
                                        </span>您好：<%= session.getAttribute("username") %>！今天是
                                        <script>
                            ...
                            <div id="rbox_middlecenter">
                                <div id="rbox_middleleft">
                                    <div id="rbox_middleright">
                                        <div id="bs_right">
                                            <IFRAME scrolling="yes" width="100%" height="100%" frameBorder=0 id=frmright name=frmright src="templete/welcome.html" allowTransparency="true">
                                            </IFRAME>
                                        </div>
                                    </div>
                                </div>
