...
<form action="../AddTableServlet" method="post">
    <table border="1" align="center" width="60%">
        <tr>
            <td class="left">*机构全称</td>
            <td colspan="2" class="right"><input class="write" type="text" name="jgqc" id="jgqc"></td>
            <td class="left">归口管理部门</td>
            <td colspan="2"><input class="write" type="text" name="gkglbm" id="gkglbm" value=""></td>
        </tr>
        <tr>
            <td class="left">*通讯地址</td>
            <td colspan="2" class="right"><input class="write" type="text" name="txdz" id="txdz"></td>
            <td class="left">*所在地域</td>
            <td colspan="2"><input class="write" type="text" name="szdy" id="szdy"></td>
        </tr>
        <tr>
            <td class="left">网址</td>
            <td colspan="2" class="right"><input class="write" type="text" name="wz" id="wz" value=""></td>
            <td class="left">*电子信箱</td>
            <td colspan="2"><input class="write" type="text" name="dzxx" id="dzxx"></td>
        </tr>
        <tr>
            <td class="left">*法人代表</td>
            <td colspan="2" class="right"><input class="write" type="text" name="frdb" id="frdb"></td>
            <td class="left">邮政编码</td>
            <td colspan="2"><input class="write" type="text" name="yzbm" id="yzbm" value=""></td>
        </tr>
        <tr>
            <td class="left">*联系人</td>
            <td class="right" colspan="2"><input class="write" type="text" name="lxr" id="lxr"></td>
            <td class="left">固定电话</td>
            <td colspan="2"><input class="write" type="text" name="gddh" id="gddh" value=""></td>
        </tr>
        <tr>
            <td class="left">*手机</td>
            <td colspan="2"><input class="write" type="text" name="sj" id="sj"></td>
            <td class="left">传真</td>
            <td colspan="2"><input class="write" type="text" name="cz" id="cz" value=""></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <div class="formControls col-xs-8 col-sm-9">
			    <!-- 核心代码 start-->
			    <textarea name="jgjj" cols="100" rows="5" class="textarea" placeholder=""
        ...
        <tr>
            ...
            <td class="right" colspan="2"><input class="write" type="text" name="jsxqmc"></td>
            <td class="left">*需求时限</td>
            <td class="right" colspan="2"><input class="write" type="text" name="qsxqsx">年-<input class="write" type="text" name="jzxqsx">年</td>
        </tr>
        <tr>
...
3、预期目标（技术创新性、经济社会效益,限500字）"
        ...
        <tr>        
            ...
            <td class="right" colspan="5"><input dir="rtl" style="width: 50%;border: 0" type="text" name="ntrjeze" id="ntrjeze"value="0">万元</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="right" colspan="3"><input  class="write" type="text" name="hzyxdw"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="6"><div align="center"><input type="submit" value="提交" onclick="return check()"></div></td>
        </tr>
    </table>
</form>
</body>
<script type="text/javascript">
		function check() {
			if (confirm("点击提交后将不可再更改，你确认要提交吗？")){
				return true;
			}else{
				return false;
			}
...
var Huitextarealength = function (obj){
    ...
    function type2(){
        ...
        var htmltext1="<td>其他技术</td> <td colspan='5'><input class='write' type='text' name='qtjs' value=''></td>";
        var htmltext2="<td>需求技术应用行业（参见国民经济行业分类，非基础研究填写）</td> <td colspan='5'><input class='write' type='text' name='xqjsyyhy' value=></td>";
        $("#type").html(htmltext);
