    ...
    <table border="1" align="center" width="60%">
        ...
        <tr>
            ...
            <div class="formControls col-xs-8 col-sm-9">
			    <textarea name="jgjj" id="jgjj" cols="100" rows="5" class="textarea" placeholder="" readonly>${table.jgjj}</textarea>
			</div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <div class="formControls col-xs-8 col-sm-9">
			    <textarea name="jsxqgs" cols="100" rows="5" class="textarea" placeholder="" readonly>${table.jsxqgs}</textarea>
			</div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="right" colspan='5'><input class="write" type='text' name='xssh' value="${table.xssh}" readonly></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="6" height="150px">
            <div class="formControls col-xs-8 col-sm-9">
			    <textarea name="xsyj" cols="100" rows="5" class="textarea" placeholder="" readonly>${table.xsyj}</textarea>
			</div>
            </td>
        </tr>
        <tr>
            <td class="left">管理处室</td> 
            <td class="right" colspan='5'><input class="write" type='text' name='glcs' value="${table.glcs}" readonly></td>
        </tr>
        <tr>
            <td class="left">部门审核状态</td> 
            <td class="right" colspan='5'><input class="write" type='text' name='bmsh' value="${table.bmsh}" readonly></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="6" height="150px">
            <div class="formControls col-xs-8 col-sm-9">
			    <textarea name="bmyj" cols="100" rows="5" class="textarea" placeholder="" readonly>${table.bmyj}</textarea>
			</div>
            </td>
        </tr>
    </table>
