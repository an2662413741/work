...
function check(){
	...
	var ssz=document.getElementById("ssz").value;
...
<!--定义表单 form-->
<form action="AdminServlet?method=changeTheUser" method="post" onsubmit="return check()">
    <table border="1" align="center" width="500">
        <tr>
            <td><input type="text" name="id" id="id" value="${user.id}" hidden></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="joker" id="joker" value="${user.joker}"></td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" name="ssz" id="ssz" value="${user.ssz}"></td>
        </tr>
        ...
        <tr>
            <td><label>省市</label></td>
            <td><SELECT name="sheng" id="to_cn" onchange="set_city(this, document.getElementById('city')); WYL();" class=login_text_input >
...
<option value=0>请选择</option>
        ...
        <tr>
            ...
            <td><input type="text" name="jgmc" id="jgmc" value="${user.jgmc}"></td>
        </tr>
        
        <tr>
            <td><label>组织机构代码</label></td>
            <td><input type="text" name="zzjgdm" id="zzjgdm" value="${user.zzjgdm}"></td>
        </tr>
        
        <tr>
            <td><label>专业方向</label></td>
            <td><input type="text" name="zyfx" id="zyfx" value="${user.zyfx}"></td>
        </tr>
        
        <tr>
            <td><label>所在行业</label></td>
            <td><input type="text" name="szhy" id="szhy" value="${user.szhy}"></td>
        </tr>
        
        <tr>
            <td><label>教育程度</label></td>
            <td><input type="text" name="jycd" id="jycd" value="${user.jycd}"></td>
        </tr>
        
        <tr>
            <td><label>职称</label></td>
            <td><input type="text" name="zc" id="zc" value="${user.zc}"></td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" name="sj" id="sj" value="${user.sj}"></td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="email" name="yx" id="yx" value="${user.yx}"></td>
        </tr>
