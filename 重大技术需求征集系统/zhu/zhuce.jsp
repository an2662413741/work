...
function check(){
	...
	var zzjgdm=document.getElementById("zzjgdm");
	var name=document.getElementById("name");
	var ssz=document.getElementById("ssz");
...
<form action="../RegisterServlet" method="post" onsubmit="return check()">
    <table border="1" align="center" width="500">
        <tr>
            ...
            <td><input type="text" name="username" id="username" placeholder="由6~20位字母或数字组成"></td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" name="ssz" id="ssz" ></td>
        </tr>
...
<option value=0>请选择</option>
        ...
        <tr>
            ...
            <td><input type="text" name="jgmc" id="jgmc" placeholder="请输入单位全称"></td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" name="yzbm" id="yzbm" ></td>
        </tr>

        <tr>
            <td><label>手机</label></td>
            <td><input type="text" name="sj" id="sj"></td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="email" name="yx" id="yx"></td>
        </tr>
